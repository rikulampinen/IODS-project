...
# more advanced biplot
autoplot(prcomp(human_stzd), data = human, colour = "darkgreen", loadings = TRUE, loadings.label = TRUE, loadings.colour = "deeppink",) + ggtitle("PCA biplot of standardized 'human' data set") 
```

PC2 is strongly associated with parliament representatives and the labour force ratio


--> check loading matrix of the PCA
